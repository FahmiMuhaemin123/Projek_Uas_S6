...
// Query untuk mendapatkan data order header
...
WHERE DATE(order_header.waktu) = '$tanggal'";
...
// Query untuk mendapatkan total menu yang terjual
$queryTotalMenu = "SELECT SUM(qty) as total
FROM order_detail 
LEFT JOIN order_header ON order_detail.id_order_header = order_header.id_order_header 
WHERE DATE(order_header.waktu) = '$tanggal'";
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0">Rp <?= $data['total'] !== null ? number_format($data['total'], 0, ',', '.') : "0"; ?></h4>
                            </div>
                        </div>
